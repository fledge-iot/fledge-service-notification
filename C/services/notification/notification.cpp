...
{
	static std::string serviceInfoJSON = R"({"name":"Notification Service","description":"Service used to detect events and send notifications to external systems","package":"fledge-service-notification","type":"notification","process":"notification_c","process_script":"[\"services/notification_c\"]","startup_priority":30})" ;
